...
1. **Check docs** — review whether `{PROJECT_PATH}/.planning/PROJECT.md` or `ARCHITECTURE.md` need updates (delegate ARCHITECTURE.md check to Implementer). If nothing needs updating, move on silently.
